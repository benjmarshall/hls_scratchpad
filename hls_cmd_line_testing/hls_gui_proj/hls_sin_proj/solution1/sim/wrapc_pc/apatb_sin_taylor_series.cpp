...
// wrapc file define: "x"
#define AUTOTB_TVIN_x  "../tv/cdatafile/c.sin_taylor_series.autotvin_x.dat"
// wrapc file define: "ap_return"
#define AUTOTB_TVOUT_ap_return  "../tv/cdatafile/c.sin_taylor_series.autotvout_ap_return.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "ap_return"
#define AUTOTB_TVOUT_PC_ap_return  "../tv/rtldatafile/rtl.sin_taylor_series.autotvout_ap_return.dat"
...
extern double sin_taylor_series (
double x);

double AESL_WRAP_sin_taylor_series (
double x)
{
			...
			// bitslice(63, 0)
			{
				// celement: x(63, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						...
						// ori_name_1st_elem     : x
						// regulate_c_name       : x
						// input_type_conversion : *(long long*)&x
						if (&(x) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<64> x_tmp_mem;
							x_tmp_mem = *(long long*)&x;
							x_tvin_wrapc_buffer.range(63, 0) = x_tmp_mem.range(63, 0);
						}
					}
				}
			}
...
// [call_c_dut] ---------->
		...
		double AESL_return = sin_taylor_series(x);
