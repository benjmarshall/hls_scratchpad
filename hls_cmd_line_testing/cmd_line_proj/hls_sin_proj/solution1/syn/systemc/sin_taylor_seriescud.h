...
#ifndef __sin_taylor_seriescud__HH__
#define __sin_taylor_seriescud__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(sin_taylor_seriescud) {
    ...
    SC_CTOR(sin_taylor_seriescud):  ACMP_sitodp_U ("ACMP_sitodp_U") {
