...
if {[file isfile sin_taylor_series.autotvin.dat]} {
	file delete -force sin_taylor_series.autotvin.dat
}

if {[file isfile sin_taylor_series.autotvout.dat]} {
	file delete -force sin_taylor_series.autotvout.dat
}
